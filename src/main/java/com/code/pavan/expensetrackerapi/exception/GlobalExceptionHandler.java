...
import com.code.pavan.expensetrackerapi.entity.ErrorObject;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handlerExpenseNotFoundException(ResourceNotFoundException ex, WebRequest request){
